...
> Bundled from [impeccable](https://github.com/pbakaus/impeccable) v2.1.1 (Apache 2.0, based on Anthropic's frontend-design skill).
> Use `/review-sources` to check for upstream updates.
...
### Typography
→ *Consult [typography reference](design-typography.md) for OpenType features, web font loading, and the deeper material on scales.*
...
### Color & Theme
→ *Consult [color reference](design-colour.md) for the deeper material on contrast, accessibility, and palette construction.*
...
### Layout & Space
→ *Consult [spatial reference](design-spatial.md) for the deeper material on grids, container queries, and optical adjustments.*
...
### Motion
→ *Consult [motion reference](design-motion.md) for timing, easing, and reduced motion.*
...
### Interaction
→ *Consult [interaction reference](design-interaction.md) for forms, focus, and loading patterns.*
...
### Responsive
→ *Consult [responsive reference](design-responsive.md) for mobile-first, fluid design, and container queries.*
...
### UX Writing
→ *Consult [ux-writing reference](design-ux-writing.md) for labels, errors, and empty states.*
